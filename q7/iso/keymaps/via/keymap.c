...
extern void openrgb_direct_mode_init(void);
extern void set_via_mode(void);
extern void set_openrgb_mode(void);
            ...
            [_FN1] = LAYOUT_iso_73(
                ...
                [_FN2] = LAYOUT_iso_73(
                    ...
                    [_FN3] = LAYOUT_iso_73(
                        ...
                        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUI, RGB_SAI, RGB_SPI, _______, _______, _______, _______, _______,  _______, _______,                     _______, _______,
                        _______, RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______,  _______, _______,  _______,           _______, _______,
                        _______, _______,  _______,  _______, _______, TOG_RGB_MODE, _______, _______, _______, _______, _______,  _______,           _______,           _______, _______,
                        _______, _______,  _______,                             _______,                            _______,  _______, _______,  _______,  _______, _______, _______)
};

// Optional: handle TOG_RGB_MODE keycode
        ...
        case TOG_RGB_MODE:
            if (record->event.pressed) {
                if (rgb_matrix_is_enabled()) {
                    ...
                    rgb_matrix_disable();
                    rgb_matrix_enable();
                    rgb_matrix_set_color_all(128, 0, 255);  // Violet flash
                    set_via_mode();
                } else {
                    // Switch to OpenRGB mode
                    rgb_matrix_enable();
                    rgb_matrix_set_flags(LED_FLAG_ALL);
                    for (int i = 0; i < RGB_MATRIX_LED_COUNT; i++) {
                        rgb_matrix_set_color(i, 255, i % 255, 255 - (i % 255));  // RGB sweep
                    }
                    set_openrgb_mode();
                }
            }
